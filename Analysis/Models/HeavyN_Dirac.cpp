...
Dirac::Dirac(const MG5_aMC::SLHAReader &slhaReader) : Generic{ModelID::HeavyN_Dirac} {
  mn1 = slhaReader.get_block_entry("mass", PID::HeavyN::Dirac::n1);
  mn2 = slhaReader.get_block_entry("mass", PID::HeavyN::Dirac::n2);
  mn3 = slhaReader.get_block_entry("mass", PID::HeavyN::Dirac::n3);
  ...
  n1Width = slhaReader.get_block_entry("decay", PID::HeavyN::Dirac::n1);
  n2Width = slhaReader.get_block_entry("decay", PID::HeavyN::Dirac::n2);
  n3Width = slhaReader.get_block_entry("decay", PID::HeavyN::Dirac::n3);
};

Dirac::Dirac(const std::vector<double> &parametersVector) : Generic{ModelID::HeavyN_Dirac} {
...
std::string Dirac::CSV() const {
  return std::format("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}", mn1, ven1, vmun1, vtan1,
                     n1Width, mn2, ven2, vmun2, vtan2, n2Width, mn3, ven3, vmun3, vtan3, n3Width);
}

std::vector<double> Dirac::Vector() const {
  return {mn1,   ven1,    vmun1, vtan1, n1Width, mn2,   ven2,   vmun2,
          vtan2, n2Width, mn3,   ven3,  vmun3,   vtan3, n3Width};
}

double Dirac::Theta1Squared() const { return (ven1 * ven1) + (vmun1 * vmun1) + (vtan1 * vtan1); }

double Dirac::Theta2Squared() const { return (ven2 * ven2) + (vmun2 * vmun2) + (vtan2 * vtan2); }

double Dirac::Theta3Squared() const { return (ven3 * ven3) + (vmun3 * vmun3) + (vtan3 * vtan3); }
}  // namespace HNL::Model::HeavyN
